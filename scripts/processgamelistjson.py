...
def classify_event(season, event_id, event_name):
    ...
    if season.isdigit():
        ...
        if event_id in ["s25divisionpp"]:
            return "MAIN"

        if event_id in ["s25divisionsfrd1la", "s25divisionsfrd1lb", "s25divisionsfrd1lc", "s25divisionsfrd1ld",
        ...
        if event_id in ["s27divisionsfrdla", "s27divisionsfrdlb", "s27divisionsfrdlc", "s27divisionsfrdld",
                        "s27divisionsfrdsl1", "s27divisionsfrdsl2", "s27divisionsfrdfl", "s27divisionsfrdf"]:
            return "DFRC"

        if event_id in ["s28divisionscat3p", "s28divisionscat2p", "s28divisionscat2pt1", "s28divisionelt1", "s28divisionelt2"]:
            return "MAIN"

        if event_id in ["s28division4kf"]:
            return "MAIN"

        if event_id in ["s28divisionl1t1"]:
            return "MAIN"

        if event_id in ["s28divisionsfrdla", "s28divisionsfrdlb", "s28divisionsfrdlc", "s28divisionsfrdld", "s28divisionsfrdldt",
                        "s28divisionsfrdsl1", "s28divisionsfrdsl2", "s28divisionsfrdfl", "s28divisionsfrdf"]:
            return "DFRC"
